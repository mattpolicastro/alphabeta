...
>
> **Req doc reference:** `requirements.md` in repo root. Section numbers cited inline as `§N.N` refer to the original v1 spec (now archived as `requirements-v1-archived.md`).
>
